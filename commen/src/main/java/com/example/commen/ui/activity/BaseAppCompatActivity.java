...
import com.example.commen.delegate.ActivityMvpDelegate;
import com.example.commen.delegate.ActivityMvpDelegateCallback;
import com.example.commen.delegate.ActivityMvpDelegateImpl;
import com.example.commen.ui.BaseAppManager;
import com.example.commen.ui.MvpPresenter;
import com.example.commen.util.CommonUtils;
import com.example.commen.util.SmartBarUtils;
import com.example.commen.util.ToolBarHelper;
import com.example.commen.util.eventbus.EventCenter;
import com.example.commen.util.netstatus.NetChangeObserver;
import com.example.commen.util.netstatus.NetStateReceiver;
import com.example.commen.util.netstatus.NetUtils;
import com.example.commen.widget.loading.VaryViewHelperController;
 ...
 */
public abstract class BaseAppCompatActivity <V extends BaseView, P extends MvpPresenter<V>>extends AppCompatActivity implements
        View.OnClickListener,ActivityMvpDelegateCallback<V, P>,BaseView {
    ...
    protected boolean retainInstance;//是否保存实例
    ...
    private static class BaseActivityHandle extends Handler {
        ...
        BaseActivityHandle(BaseAppCompatActivity outer) {
        ...
        public void handleMessage(android.os.Message msg) {
            BaseAppCompatActivity aty = mOuterInstance.get();
